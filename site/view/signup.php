...
<body >
  ...
  <div class="form">
    <p class="notice">WELCOME TO FAKE!</p>
    ...
    <form class="login-form" action="" method="POST">
      ...
      <p >
       ...
       <p class="message">Bằng việc đăng kí, bạn đã đồng ý với Bookstore về <a href="" target="_blank">Điều khoản dịch vụ</a> và <a href="" target="_blank">Chính sách bảo mật</a> </p>
    </form>
  </div>
</div>
