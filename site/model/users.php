<?php	
		...
		class User extends Database
		{
			...
			public function SignUpUser($data)
			{
					...
					if($user_name==""||$name==""||$password==""||$phone==""||$email==""||$address==""||$avata==""){
					...
					//Kiểm tra tài khoản đăng kí
						...
						//Sau khi kiểm tra, chèn thông tin user mới vào CSDL
							...
							$query="INSERT INTO user( name, user_name, email, phone, address, password, avata) VALUES ('$name','$user_name','$email','$phone','$address','$password', '$avata')";
			...
			public function UpdataUser($data,$id)
			{
					...
					if($name==""||$phone==""||$email==""||$address==""){
						echo '<script language="javascript">';
                       	echo 'document.addEventListener("DOMContentLoaded", function() {';
                       	echo ' alertify.alert("Bạn phải điền đầy đủ thông tin!")';
						echo '});';
						echo '</script>';
					}
